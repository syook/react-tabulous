...
import { ColumnHeaders } from '../../../../reactTabulous/components/columnHeaders';
...
describe('ColumnHeaders', () => {
  test('should render correctly', () => {
    ...
    const [nameSortButton, nameKebabButton, emailSortButton, emailKebabButton] = screen.getAllByRole('button');
