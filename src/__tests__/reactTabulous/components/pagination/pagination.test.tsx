...
import { Pagination } from '../../../../reactTabulous/components/pagination';
...
describe('Pagination', () => {
  test('should render correctly', () => {
    ...
    const [firstPageButton, previousPageButton, nextPageButton, lastPageButton] = screen.getAllByRole('button');
